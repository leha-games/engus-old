...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Card.when_learned'
        db.add_column(u'cards_card', 'when_learned',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Card.when_learned'
        db.delete_column(u'cards_card', 'when_learned')
    ...
    models = {
        ...
        u'cards.card': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'learned': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
