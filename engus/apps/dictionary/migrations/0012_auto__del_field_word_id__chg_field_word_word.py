...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Word.id'
        db.delete_column(u'dictionary_word', u'id')


        # Changing field 'Word.word'
        db.alter_column(u'dictionary_word', 'word', self.gf('django.db.models.fields.CharField')(max_length=32, primary_key=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Word.id'
        raise RuntimeError("Cannot reverse this migration. 'Word.id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Word.id'
        db.add_column(u'dictionary_word', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)


        # Changing field 'Word.word'
        db.alter_column(u'dictionary_word', 'word', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True))
