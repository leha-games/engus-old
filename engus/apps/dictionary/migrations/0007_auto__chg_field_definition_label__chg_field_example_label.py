...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Example.label'
        db.delete_column(u'dictionary_example', 'label')
        db.add_column(u'dictionary_example', 'label', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Example.label'
        db.delete_column(u'dictionary_example', 'label')
        db.add_column(u'dictionary_example', 'label', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
