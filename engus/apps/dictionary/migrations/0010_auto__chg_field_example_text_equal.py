...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Example.text_equal'
        db.alter_column(u'dictionary_example', 'text_equal', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Example.text_equal'
        db.alter_column(u'dictionary_example', 'text_equal', self.gf('django.db.models.fields.CharField')(max_length=100))
