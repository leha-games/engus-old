...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Definition.explanation'
        db.alter_column(u'dictionary_definition', 'explanation', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Definition.label'
        db.alter_column(u'dictionary_definition', 'label', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Definition.where_used'
        db.alter_column(u'dictionary_definition', 'where_used', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Definition.explanation'
        db.alter_column(u'dictionary_definition', 'explanation', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Definition.label'
        db.alter_column(u'dictionary_definition', 'label', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Definition.where_used'
        db.alter_column(u'dictionary_definition', 'where_used', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        u'dictionary.definition': {
            ...
            'where_used': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'dictionary.example': {
            ...
            'text_equal': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
        u'dictionary.word': {
