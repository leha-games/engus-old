...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Definition.where_used'
        db.add_column(u'dictionary_definition', 'where_used',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Definition.where_used'
        db.delete_column(u'dictionary_definition', 'where_used')
