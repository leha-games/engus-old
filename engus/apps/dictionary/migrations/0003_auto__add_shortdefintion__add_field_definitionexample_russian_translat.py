...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DefinitionExample.russian_translation'
        db.add_column(u'dictionary_definitionexample', 'russian_translation',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DefinitionExample.russian_translation'
        db.delete_column(u'dictionary_definitionexample', 'russian_translation')
    ...
    models = {
        ...
        u'dictionary.shortdefintion': {
            'Meta': {'object_name': 'ShortDefintion'},
            'definition': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'russian_definition': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'word': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['dictionary.Word']", 'unique': 'True'})
