...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Word.is_oxford_3000'
        db.add_column(u'dictionary_word', 'is_oxford_3000',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Word.is_oxford_3000'
        db.delete_column(u'dictionary_word', 'is_oxford_3000')
