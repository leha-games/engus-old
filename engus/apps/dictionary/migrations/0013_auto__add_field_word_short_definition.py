...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Word.short_definition'
        db.add_column(u'dictionary_word', 'short_definition',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Word.short_definition'
        db.delete_column(u'dictionary_word', 'short_definition')
