...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dictionary_definition', 'definition', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Definition.example_russian_translation'
        db.alter_column(u'dictionary_definition', 'example_russian_translation', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Definition.russian_definition'
        db.alter_column(u'dictionary_definition', 'russian_definition', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Definition.example'
        db.alter_column(u'dictionary_definition', 'example', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Definition.example_russian_translation'
        db.alter_column(u'dictionary_definition', 'example_russian_translation', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Definition.russian_definition'
        db.alter_column(u'dictionary_definition', 'russian_definition', self.gf('django.db.models.fields.TextField')(max_length=255))

        # Changing field 'Definition.example'
        db.alter_column(u'dictionary_definition', 'example', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        u'dictionary.definition': {
            ...
            'example': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'example_illustration': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'example_russian_translation': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
