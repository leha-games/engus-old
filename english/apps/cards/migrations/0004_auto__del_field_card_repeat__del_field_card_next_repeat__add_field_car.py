...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Card.next_repeat'
        db.delete_column(u'cards_card', 'next_repeat')

        # Adding field 'Card.level'
        db.add_column(u'cards_card', 'level',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Card.next_repeat'
        db.add_column(u'cards_card', 'next_repeat',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Card.level'
        db.delete_column(u'cards_card', 'level')
